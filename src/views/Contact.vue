<template>
  <div class="contact">
    <section class="container" v-if="formSubmitted">
      <div>
        Thank you for contacting me, <span class="name">{{ name }}</span
    ...
    <form
      ...
      v-if="!isLoading"
    >
      <div class="text-danger" v-if="formInvalid">
            ...
            <div class="form-group">
              <div>
                <textarea
                  ...
                  class="form-control user-success"
                ></textarea>
              </div>
            </div>
          </div>
