    ...
    <div class="update-user__content">
      ...
      <div class="action">
        ...
        <button
            ...
            @click.prevent="createUserProfile"
        >
          <span class="btn-inner--icon">
  ...
  methods: {
    ...
    async createUserProfile () {
      try {
        ...
        if (refsValid) {
          const res = await userProfileService.createUserProfile(this.formData)
          await Swal.fire({
            title: `Tạo user profile thành công với id ${res.userId}`,
            text: ``,
            icon: 'success',
